        ...
        <div class="box-body">
          <div class="row">
              <div class="col-md-12">
                ...
                <input type="hidden" value="<?=$financial->row()->id_transaksi?>" name="id_transaksi">
                ...
                <div class="form-group">
                  <label>Member</label>
                  <select class="form-control select2" selected="<?=$financial->row()->id_member?>" style="width: 100%;" name="id_member">
                    <?php
                      foreach ($member->result_array() as $id_member) {
                          echo "<option value='".$id_member['id_member']."' ";
                          echo ($financial->row()->id_member == $id_member['id_member']) ? "selected":"";
                          echo ">".$id_member['nama']."</option>";
                      }
                    ?>
                  </select>
                </div>
                  ...
                  <select class="form-control select2" selected="<?=$financial->row()->id_kategori?>" style="width: 100%;" name="id_kategori">
                    <?php
                      foreach ($kategori->result_array() as $id_kategori) {
                          echo "<option value='".$id_kategori['id_kategori']."' ";
                          echo ($financial->row()->id_kategori == $id_kategori['id_kategori']) ? "selected":"";
                          echo ">".$id_kategori['nama_kategori']."</option>";
                      }
                    ?>
                  </select>
                </div>
